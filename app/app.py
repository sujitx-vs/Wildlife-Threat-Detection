...
# st.title("WildLife Threat Detection.")

# model = load_model(MODEL_PATH)

# st.write("Upload the audio file")

# s_audio = st.file_uploader("Upload the file",type=["wav"])

# if s_audio is not None:
#     st.audio(s_audio)
#     y,sr = librosa.load(s_audio,sr=22050)# 22050 is the standard value so that all sample is standardized.
...
#     # print(sample_spectro.shape)
#     sample_spectro= np.expand_dims(sample_spectro, axis=0)
#     # print(sample_spectro.shape)
#     sample_spectro= np.expand_dims(sample_spectro, axis=-1)
#     # print("final",sample_spectro.shape)
#     # print(model.input_shape)
#     # sample_spectro = sample_spectro.transpose(0, 2, 3, 1)
#     pred = model.predict(sample_spectro)
#     st.write(pred)
#     if pred > 0.5:
#         st.header("Threat")
#     else :
#         st.header("WildLife")
# else:
#     st.write("Error in Upload Please Try again!!")


# Just the testing code, the wroking of the model and testing sample.
...
# st.sidebar.title("🌿 About EcoGuard AI")
...
# st.caption(
# "Wildlife Threat Detection using Environmental Audio Analysis"
# )
...
# "Upload Environmental Audio (.wav)",
# type=["wav"]
# )
...
#         sample_spectro = np.array(
#             spectrogram
#         )

#         sample_spectro = np.expand_dims(
#             sample_spectro,
#             axis=0
#         )
...
#         st.warning(
#             "Potential human or industrial activity detected in the recording."
#         )
...
# else:
#     st.info(
#      "Upload a .wav audio recording to begin analysis."
#     )
